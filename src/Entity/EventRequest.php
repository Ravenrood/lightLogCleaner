...
class EventRequest
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="State", inversedBy="event_request")
     * @ORM\JoinColumn(name="id_state", referencedColumnName="id")
     */
    private $state;

    /**
     * @ORM\ManyToOne(targetEntity="EventLog", inversedBy="event_request")
     * @ORM\JoinColumn(name="id_event_log", referencedColumnName="id")
     */
    private $event_log;
